...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see com.i2i.netbankingapplication.service.impl.PasswordTokenManager#generateRecoveryToken(com.i2i.netbankingapplication.model.User)
     */
    @Override
    ...
    /**
     * @see com.i2i.netbankingapplication.service.impl.PasswordTokenManager#isRecoveryTokenValid(com.i2i.netbankingapplication.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see com.i2i.netbankingapplication.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
