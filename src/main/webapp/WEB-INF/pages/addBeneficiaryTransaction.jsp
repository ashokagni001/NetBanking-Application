		...
		<form method="get" action="insertTransaction">
			...
			<div class="row">
				<div class="form-group">
					...
					<div class="col-md-8">
						<input name="creditAccountNumber"
							value="<c:out value="${customerAccount.getAccountNumber()}"/>"
							readonly />
					</div>
				</div>
			</div>
			<div class="row">
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text"
							value="<c:out value="${customerAccount.getUser().getFirstName()}"/>"
							readonly />
					</div>
				</div>
			</div>
				...
				<div class="form-group">
					<div class="col-md-offset-4 col-md-8">
						<input class="btn btn-success" type="submit"
							name="insertTransaction" value="PROCEED" />
					</div>
				</div>
			</div>
		</form>
