...
import com.i2i.netBankingApplication.service.TransactionManger;
...
public class TransactionController {
    ...
    public ModelAndView addBeneficiaryAccount(@RequestParam("accountNumber")String accountNumber, 
        ...
        try { 
            ...
            return new ModelAndView ("addBeneficiaryAccount", "message", transactionManger.addBeneficiaryAccount(user, accountNumber, IFSCode)); 
