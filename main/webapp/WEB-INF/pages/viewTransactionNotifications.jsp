							...
							<c:forEach items="${notifications}" var="notifications">
								<tr>
									...
									<td align="center" height="30" width="100"><a
										href="transactionSuccess?id=<c:out value="${notifications.getId()}"/>&creditAccountNumber=<c:out value="${accountCredit.accountNumber}"/>&amount=<c:out value="${notifications.getAmount()}"/>"
