    ...
    <body>
        ...
        <center>
            ...
            <table>
                ...
                <tr>
                    <td align="center" height="40" width="350">
                        <a class = " btn btn-link" href="GetBranch">FETCH BRANCH</a>
                    </td>
                </tr> 
                <tr>
                    <td align="center" height="40" width="350">
                        <a class = " btn btn-link" href="AddAccount">ADD ACCOUNT</a>
                    </td>
                </tr> 
                <tr>
                    <td align="center" height="40" width="350">
                        <a class = " btn btn-link" href="ViewAccountByBranch">View  ACCOUNT By Branch</a>
                    </td>
                </tr>  
            </table> 
        </center>
