...
<body>
    <c:if test="${sessionScope['role']!= 'approver'}">
        ...
        <table class=" table table-bordered">
            ...
            <tr>
                <td align="center">
                    <c:out value="${accountDetail.getAccountNumber()}" />
                </td>
                ...
                <td align="center">
                    <c:out value="${branch.IFSCode}" />
                </td>
                <td align="center">
                    <c:out value="${accountDetail.getBalance()}" />
                </td>
                <td align="center">
                    <c:out value="${accountDetail.getAccountType()}" />
                </td>
            </tr>
        </table>
    ...
    <c:if test="${sessionScope['role'] != 'user'}">
        ...
        <table class=" table table-bordered">
            ...
            <tr>
                ...
                <td align="center" height="30" width="100"><a href="getCustomer?customerId=<c:out value="${customer.customerId}"/>" style="color: blue">VIEW USER DETAIL</a>
                </td>
            </tr>
        </table>
        <a href="approverIndexPage">Go to main page</a>
