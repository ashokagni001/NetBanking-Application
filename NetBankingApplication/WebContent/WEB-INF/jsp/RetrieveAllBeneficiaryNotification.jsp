					...
					<div class="col-md-12 sizetable">
						<table class="table table-striped table-bordered table-hover"
							...
							<%
							    int sno = 1;
							%>
							<c:forEach items="${beneficiaryNotifications}" var="beneficiaryNotifications">
								<tr>
									<td align="center"><c:out value="<%=sno%>" /></td>
									<td align="center"><c:out value="${beneficiaryNotifications.getId()}" /></td>
									<td align="center"><c:set
											value="${beneficiaryNotifications.getBeneficiaryAccountNumber()}" var="beneficiaryCustomer" />
										<a
