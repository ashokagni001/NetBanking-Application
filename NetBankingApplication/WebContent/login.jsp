...
<html>
<head>
    <title>I2I NETBANKING LOGIN FORM</title>
...
<body>
    <div class="wrapper">
        <form class="login" action="loginController" method="post">
            ...
            <input type="text" name="customerId" placeholder="CUSTOMER ID" autofocus required />
            <input type="password" name="password" placeholder="PASSWORD" required /> <i class="fa fa-key"></i>
            <button>
    ...
    <div class="wrapper">
        <form class="login" action="loginController" method="post">
            ...
            <input type="text" name="customerId" placeholder="CUSTOMER ID" autofocus required /> <i class="fa fa-user"></i>
